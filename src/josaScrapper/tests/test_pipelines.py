...
from logger import *
from src.josaScrapper.entity.config_entity import DataIngestionConfig,DataValidationConfig
...
from src.josaScrapper.entity.artifact_entity import DataValidationArtifact
import asyncio
